...
const PaymentPage = ({
  ...
  const displayAmount = useMemo(() => formatPrice(amountNumber), [amountNumber, formatPrice]);
        ...
        <div style={styles.sheet}>
          <div style={{ padding: 32, textAlign: "center" }}>
            ...
            <p style={{ color: "#6b7280", fontSize: 14, margin: "0 0 8px" }}>
              {displayAmount} successfully paid
            </p>
      ...
      <div style={styles.sheet}>
        <div style={styles.header}>
          <div style={styles.titleRow}>
            ...
            <div style={styles.totalBadge}>{displayAmount}</div>
          </div>
        ...
        <div style={styles.body}>
            ...
            <div style={{ display: "grid", gap: 16 }}>
              ...
              >
                {bankLoading ? (
                  ...
                  <>
                    <span>🏦</span>
                    Pay {displayAmount} via Net Banking
                  </>
                )}
              </button>
            </div>
          ...
          <div style={styles.summary}>
            ...
            <div style={{ textAlign: "right" }}>
              ...
              <p style={{ margin: "4px 0 0", fontSize: 18, fontWeight: 800, color: "#111827" }}>{displayAmount}</p>
            </div>
          </div>
