    ...
    <div style={{ background:THEME.bg, minHeight:"100vh" }}>
      ...
      <div style={{ background:`linear-gradient(135deg, ${THEME.crimsonLight}, ${THEME.bg})`, padding:"120px 40px 80px", textAlign:"center", position:"relative", overflow:"hidden" }}>
        ...
        <div style={{ position:"relative", zIndex:1 }}>
          ...
          <h1 style={{ fontFamily:"'Playfair Display',serif", fontSize:"clamp(40px,7vw,80px)", fontWeight:900, color:THEME.text, marginBottom:"16px" }}>Our Story</h1>
          <p style={{ fontFamily:"'Poppins',sans-serif", fontSize:"16px", color:THEME.text, fontWeight:600, letterSpacing:"2px", marginBottom:"8px" }}>Nouveau — By Jinal & Team</p>
          <p style={{ fontFamily:"'Poppins',sans-serif", fontSize:"16px", color:THEME.textMuted, fontStyle:"italic", maxWidth:"600px", margin:"0 auto", lineHeight:1.7 }}>Where Tradition Meets Modern Elegance</p>
        </div>
      </div>
      ...
      <div style={{ maxWidth:"900px", margin:"0 auto", padding:"80px 40px" }}>
        ...
        <div style={{ marginBottom:"60px" }}>
          ...
          <p style={{ fontFamily:"'Poppins',sans-serif", fontSize:"16px", color:THEME.textMuted, lineHeight:1.85, marginBottom:"20px" }}>
            Nouveau is a contemporary ethnic wear label for women, founded in 2025 by Jinal. The brand embodies fresh design thinking while staying rooted in Indian traditions, offering chic, comfortable, and elegant outfits that redefine everyday ethnic fashion with a perfect balance of heritage and modernity.
          </p>
